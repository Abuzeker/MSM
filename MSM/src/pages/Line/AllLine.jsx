        ...
        <div>
            ...
            <div style={{ marginTop: '16px' }}>
                <Card >
                    ...
                    <h2>{`( ${moment(ContingRange[0]).utc(true).format('DD/MM/YYYY HH:mm:ss')} - ${moment(ContingRange[3]).utc(true).format('DD/MM/YYYY HH:mm:ss')} )`}</h2>
                    ...
                    <Row gutter={[16, 16]} >
                        <Col span={6} xs={24} xl={12}>
                            <Card bordered={true} style={{ backgroundColor: 'ButtonHighlight ', border: '3px outset', minHeight: '300px' }}  >
                                ...
                                <Row gutter={'1'} >
                                        ...
                                        <Row gutter={'1'} >
                                            <Col span={8} xs={24} xl={24}>
                                                ...
                                                <Statistic
                                                    ...
                                                    precision={0}
                                                    valueStyle={{ color: '#3f8600', fontSize: '70px', color: '#131212', fontWeight: 'bold' }}
                                                    suffix={<h1 style={{ fontSize: '30px' }}>Unit</h1>}
                                                />
                                            </Col>
                                    ...
                                    <Col span={8} xs={12} xl={12}>
                                        <Statistic
                                            title={<h2 style={{ fontSize: '40px' }}>Total:</h2>}
                                            value={DailyRealTime['Line1kg']}
                                            precision={0}
                                            valueStyle={{ color: '#3f8600', fontSize: '150px', color: '#131212', fontWeight: 'bold' }}
                                            suffix={<h1 style={{ fontSize: '30px' }}>Unit</h1>}
                                        />
                        ...
                        <Col span={6} xs={24} xl={12}>
                        <Card bordered={true} style={{ backgroundColor: 'ButtonHighlight ', border: '3px outset', minHeight: '300px' }}  >
                                <Title>Packaging Line 50 KG</Title>
                        ...
                        <Col span={6} xs={24} xl={12}>
                        <Card bordered={true} style={{ backgroundColor: 'ButtonHighlight ', border: '3px outset', minHeight: '300px' }}  >
                                <Title>Packaging Line 1 Ton</Title>
